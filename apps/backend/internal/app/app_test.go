...
func TestRouteContract(t *testing.T) {
	want := []Route{
		...
		{Method: "GET", Path: "/search/recent", Authenticated: true},
		{Method: "POST", Path: "/search/recent", Authenticated: true},
		{Method: "DELETE", Path: "/search/recent/{id}", Authenticated: true},
		{Method: "DELETE", Path: "/search/recent", Authenticated: true},
